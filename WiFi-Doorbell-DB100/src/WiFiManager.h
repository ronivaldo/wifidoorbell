...
const char HTTP_STYLE[] PROGMEM           = "<style>h3{text-align:left;color:#717174;} input{width:95%;margin:5px;padding:10px;font-size:1em;box-sizing: border-box;border: none;border-bottom: 1px solid #717174;background-color: #edeff2;} body{background-color: #edeff2;font-family:verdana;} .q{float: right;width: 64px;text-align: right;} .l{background: url(\"data:image/png;base64,\") no-repeat left center;background-size: 1em;}ul{list-style-type: none;margin: 0;padding: 0;width: 100%;background-color: white;}li a {display: block;color: #000;border: 1px solid #dcdcdc;padding: 8px 16px;text-align: left;text-decoration: none;}li a:hover {background-color: #dcdcdc;}</style>";
